...
test: julia.o
	$(GPP) -I$(INCLUDE_DIR) -I$(GTEST_DIR)/include test/testmain.cc test/julia_test.cc $(SRCS_DIR)/julia.c $(GTEST_ARCHIVE) $(GTEST_MAIN_ARCHIVE) -lpthread -o $(OUTPUT_TEST_BIN_NAME)
